  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?= base_url('/') ?>" class="nav-link"><i class="fa fa-home" aria-hidden="true"></i><?= trans('home') ?></a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?= base_url('admin/auth/logout') ?>" class="nav-link"><i class="fa fa-sign-out" aria-hidden="true"></i><?= trans('logout') ?></a>
      </li>
    </ul>
